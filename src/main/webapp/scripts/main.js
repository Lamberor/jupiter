// IIFE to ensure the function name does not conflict with other scripts
(function () {
    ...
    /**
     * Initialize major event handlers9
     */
    function init() {
    ...
    // If no nearby items, hardcode it
    ...
    function getLocationFromIP() {
        ...
        // !! We comment out the following code to realize hardcode, since the deprecated getGeoLocation method
    ...
    function register() {
        ...
        // hashing (from the source script imported in the HTML)
        password = md5(username + md5(password));
