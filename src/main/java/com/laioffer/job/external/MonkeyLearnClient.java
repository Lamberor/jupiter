...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "15ed93d2e3c7731abaeb888d045798d326d4c3fb";
    ...
    public static void main(String[] args) {
        ...
        List<String> articles = Arrays.asList(
                "Elon Musk has shared a photo of the spacesuit designed by " +
                        "SpaceX. This is the second image shared of the new design and the first " +
                        "to feature the spacesuit’s full-body look.",
                "Former Auburn University football coach Tommy Tuberville " +
                        "defeated ex-US Attorney General Jeff Sessions in Tuesday nights runoff " +
                        "for the Republican nomination for the U.S. Senate. ",
                "The NEOWISE comet has been delighting skygazers around the " +
                        "world this month – with photographers turning their lenses upward and " +
                        "capturing it above landmarks across the Northern Hemisphere."
        );
